...
namespace PracticeBug
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void InitSim()
        {
            ...
            if (isAllopatric)
            {
                //Siticone.Desktop.UI.WinForms.SiticoneShapes midLine = new Siticone.Desktop.UI.WinForms.SiticoneShapes();
                //midLine.Size = new Size(4, 2000);
                //midLine.PolygonSides = 4;
                //midLine.FillColor = Color.Gray;
                //midLine.Tag = "block";
                //midLine.Location = new Point(498, -500);
                //Controls.Add(midLine);
            }
